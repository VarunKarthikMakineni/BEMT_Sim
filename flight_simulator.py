...
class mission_planner:
    ...
    def main(self):
        ...
        for i in range(0, len(self.times)-1):
            if self.current_altitude[-1]<=self.altitudes[i]:
                for t in range(self.times[i],self.times[i+1],dT):
                   ...
                   #updating helicopter parameters
                    ...
                    self.current_altitude.append(self.altitudes[-1]+self.climb_vel[-1]*60)
    ...
    def hover_and_climb(self,i):
        self.climb_vel.append((self.altitudes[i+1]-self.current_altitude[-1])/(self.times[i+1]-self.current_time[-1]))
    ...
    def collectives(self):
       ...
       #return fsolve(self.heli.hover,[0,0],(self.climb_vel[-1],self.current_altitude[-1],self.current_mass[-1]*g,0))   
