...
from flight_simulator import flight_dynamics            # Importing dummy data developed under SimulationData class 

root = tk.Tk()                                       # Creating the main window for the application
""" Change SimulationData() class to your respective class """
sim_data = flight_dynamics("input_files/helicopter.json")                          # Creating an instance of the SimulationData class
...
def run_simulation():
    ...
    try:
        ...
        plots_data["Forces X"] = sim_data.force_x(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch )
        plots_data["Forces Y"] = sim_data.force_y(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
        plots_data["Forces Z"] = sim_data.force_z(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
        #plots_data["Forces XYZ"] = sim_data.forces_xyz(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
        plots_data["Moments X"] = sim_data.moment_x(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
        plots_data["Moments Y"] = sim_data.moment_y(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
        plots_data["Moments Z"] = sim_data.moment_z(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
        #plots_data["Moments XYZ"] = sim_data.moment_xyz(collective_pitch, tail_rotor_collective)#lateral_pitch, longitudinal_pitch, tail_rotor_collective)
